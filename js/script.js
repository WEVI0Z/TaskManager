...
function tasksBoardControl() {
    ...
    boardFragmentsList.push(cardCreationControl());
    boardFragmentsList.push(cardsControl());
    boardFragmentsList.push(loadMoreButtonControl());
